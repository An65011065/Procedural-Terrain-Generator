...
const cameraStartY = 15;  // Starting position
const cameraEndY = 1.7;  // Ending position
const cameraStartPosition = new THREE.Vector3(-5.715, cameraStartY, -0.654);
const cameraEndPosition = new THREE.Vector3(-5.715, cameraEndY, -5.654);

let startAnimation = true;
let animationDuration = 4; // Duration in seconds
